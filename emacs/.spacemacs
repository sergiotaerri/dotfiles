...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(doom-themes tldr olivetti)
...
(defun dotspacemacs/user-config ()
  ...
  (add-hook 'olivetti-mode-hook (lambda () (olivetti-set-width 80)))
  ...
  ;; reveal.js conf
  (setq org-re-reveal-root "file:///home/serjo/Downloads/share/reveal.js")

  ;; Dumb fixes
  (defvaralias 'helm-c-yas-space-match-any-greedy 'helm-yas-space-match-any-greedy "Temporary alias for Emacs27")

  (spacemacs/declare-prefix "od" "dumb-fixes")
  ;; (spacemacs/set-leader-keys "ods" (shell-command (concat "ln -s ~/Downloads/org-html-themes/styles " (getenv "PWD") "/styles")) "org-theme-local-style" )
